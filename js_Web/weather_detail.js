...
function Weather_Detail(data)
{
	...
	hour=      [data.result.hourly.skycon[0].datetime.split("\x20")[1]+"<font style='font-size: 12px; color: rgba(255,255,255,0.375)'>现在</font>",
	...
	for (i=1;i<48;i++)
	{
		...
		switch (tag)
		{
			case 1: hour[i]+="<font style='font-size: 12px; color: rgba(255,255,255,0.375)'>明天</font>";break;
			case 2: hour[i]+="<font style='font-size: 12px; color: rgba(255,255,255,0.375)'>后天</font>";break;
		}
	}
	...
	document.getElementById("weather_detail").style.background="rgba(255, 255, 255, 0.125)";
	for (i=1;i<=20;i++)
		(function(i)
		{
			setTimeout(function(){width+=20-i;document.getElementById("weather_detail").style.width=(width*100/191)+"%";},20*i);
		})(i)
		var text=
				"<div id='weather_detail_inner' style='height: 100%; width: 100%'>"+
				"<div id='realtime' style='margin: 5px; filter: opacity(0%); text-align: center; position: absolute; right: 50%; bottom: 50%; width: 40%; height: 40%; background: rgba(255, 255, 255, 0.125)'>"+
				...
				"<td style='font-size: 20px; color: rgba(255,255,255,0.375)'>"+"/</td>"+
				"<td style='font-size: 20px; color: rgba(255,255,255,0.375)'>"+Min_temperature+"℃</td>"+
				"</tr></table><br><br>"+
				"<p style='font-size: 20px; color: rgba(255,255,255,0.375); line-height:1.5; width: 60%; margin:0 auto'>"+
				hourly_description+"<br><br>"+forecast_keypoint+
				"</p>"+
				"</div>"+
				"<div id='daily' style='margin: 5px; filter: opacity(0%); position: absolute; right: 50%; top: 50%; width: 40%; height: 40%; background: rgba(255,255,255,0.125)'>"+
				...
				"<font style='font-size: 12px; color: rgba(255,255,255,0.375)'>今日</font></td>"+
				...
				"<td align='right' style='font-size: 20px; color: rgba(255,255,255,0.375)'>"+"/</td>"+
				"<td align='right' style='font-size: 20px; color: rgba(255,255,255,0.375)'>"+daily_Min_temperature[0]+"℃&nbsp;</td>"+
				"</tr></table>"+
				...
				"<td align='right' style='font-size: 20px; color: rgba(255,255,255,0.375)'>"+"/</td>"+
				"<td align='right' style='font-size: 20px; color: rgba(255,255,255,0.375)'>"+daily_Min_temperature[1]+"℃&nbsp;</td>"+
				"</tr></table>"+
				"<div style='width: 90%; margin-left: 5%; height: 2px; background: rgba(255,255,255,0.125)'></div>"+
				"<table align='center' width=90% height=19%>"+
				"<tr>"+
				...
				"<td align='right' style='font-size: 20px; color: rgba(255,255,255,0.375)'>"+"/</td>"+
				"<td align='right' style='font-size: 20px; color: rgba(255,255,255,0.375)'>"+daily_Min_temperature[2]+"℃&nbsp;</td>"+
				"</tr></table>"+
				"<div style='width: 90%; margin-left: 5%; height: 2px; background: rgba(255,255,255,0.125)'></div>"+
				"<table align='center' width=90% height=19%>"+
				"<tr>"+
				...
				"<td align='right' style='font-size: 20px; color: rgba(255,255,255,0.375)'>"+"/</td>"+
				"<td align='right' style='font-size: 20px; color: rgba(255,255,255,0.375)'>"+daily_Min_temperature[3]+"℃&nbsp;</td>"+
				"</tr></table>"+
				"<div style='width: 90%; margin-left: 5%; height: 2px; background: rgba(255,255,255,0.125)'></div>"+
				"<table align='center' width=90% height=19%>"+
				"<tr>"+
				...
				"<td align='right' style='font-size: 20px; color: rgba(255,255,255,0.375)'>"+"/</td>"+
				"<td align='right' style='font-size: 20px; color: rgba(255,255,255,0.375)'>"+daily_Min_temperature[4]+"℃&nbsp;</td>"+
				"</tr></table></div>"+
				"<div id='hourly' style='margin-left: 5px; filter: opacity(0%); position: absolute; left: 50%; top: 10%; width: 40%; height: 80%; background: rgba(255, 255, 255, 0.125)'>"+
				...
				"</tr></table>"+
				"</div></div></div>";
	setTimeout(function(){document.getElementById("weather_detail").innerHTML=text;},400);
	for (i=1;i<=20;i++)
		(function(i)
		{
			setTimeout(function(){document.getElementById("realtime").style.filter="opacity("+(5*i)+"%)";},400+20*i);
			setTimeout(function(){document.getElementById("daily").style.filter="opacity("+(5*i)+"%)";},800+20*i);
			setTimeout(function(){document.getElementById("hourly").style.filter="opacity("+(5*i)+"%)";},1200+20*i);
		}(i))
}
...
function Switch_Page_Down()
{
			...
			setTimeout(function()
				{
					...
					document.getElementById("page").style.filter="opacity("+(20-i)*5+"%)";
				},20*i);
		}(i,margin))
	}
	for (i=1;i<=20;i++)
	{
		...
		(function(i,margin)
		{
			setTimeout(function()
				{
					document.getElementById("page").style.marginTop=margin+"px";
					document.getElementById("page").style.filter="opacity("+i*5+"%)";
				},600+20*i);
		}(i,margin))
	}
	var text=   "<table align='center' width=90% height=8%>"+
				...
				"</tr></table>";
	setTimeout(function(){document.getElementById("page").innerHTML=text},400);
	if (page!=1)
		setTimeout(function(){document.getElementById("UP").style.filter=""},1000);
	else
		setTimeout(function(){document.getElementById("UP").style.filter="opacity(37.5%)"},1000);
	if (page!=4)
		setTimeout(function(){document.getElementById("DOWN").style.filter=""},1000);
	else
		setTimeout(function(){document.getElementById("DOWN").style.filter="opacity(37.5%)"},1000);
}
...
function Weather_Detail_Fold()
{
	...
	for (i=1;i<=20;i++)
		(function(i)
		{
			setTimeout(function(){width-=i;document.getElementById("weather_detail").style.width=(width*100/191)+"%";},400+20*i);
			setTimeout(function(){document.getElementById("weather_detail_inner").style.filter="opacity("+(100-5*i)+"%)";},20*i);
		})(i)
	setTimeout(function(){document.getElementById("weather_detail").style.background="rgba(255, 255, 255, 0)";},400+20*i);
	setTimeout(function(){document.getElementById("weather_detail").innerHTML="";},20*i);
}